...
| :------------: | :---: | :-----: |
| Data fundamnentals | Data cleaning, Dummy encoding, Feature selection and transformation, Distances (Loss functions) and Similarities (Rank correlation) | Pandas, NumPy |
