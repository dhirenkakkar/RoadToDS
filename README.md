...
| Norms & Regularization | Lasso, Ridge & ElastricNet regression, Robust regression, Non-convex approximation using Huber loss & log-sum-exp, Frobenius norm, M-estimator | |
