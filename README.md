...
| [Matrix Algebra](https://courses.students.ubc.ca/cs/courseschedule?pname=subjarea&tname=subj-course&dept=MATH&course=221) | Matrices & Determinants, Linear independence & transformation, Vector-span, High dimensional subspaces, Digonalization, Eigenvalues & Eigenvectors, Orthogonal projections | MATH221, UBC |
