...
| Distance based classifiers | K-nearest neighbours, Lazy learning, Decision stump and trees, Greedy recursive splitting, Gaussian discriminant analysis (LDA,QDA) | |
| 3 | | |
