...
| [Matrix Algebra](https://courses.students.ubc.ca/cs/courseschedule?pname=subjarea&tname=subj-course&dept=MATH&course=221) | Matrices & Determinants, Linear independence & transformation, Vector-span, High-dim subspaces, Digonalization, Eigenvalues & Eigenvectors, Orthogonal sets & projections | MATH221, UBC |
