...
| :------------: | :---: | :-----: |
| [Machine Learning*](https://www.coursera.org/learn/machine-learning) | Linear & Logistic regression, L0/L1/L2 Regularization, Support vector machines (SVM), Unsupervised learning, Anomaly detection, Recommender systems | Coursera |
