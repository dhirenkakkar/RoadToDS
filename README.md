...
| :------------: | :---: | :-----: |
| Data fundamnentals | Data cleaning, Dummy variables (one-hot encoding), Feature selection & transformation, Distances (Hamming, Jaccard) and Similarities (Rank correlation) | |
