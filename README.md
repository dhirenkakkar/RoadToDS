...
| [Machine learning](https://www.cs.ubc.ca/~schmidtm/Courses/340-F19/) | Supervised learning (Linear & Probabilistic models), Regularization, MLE/MAP, Unsupervised learning, Latent-factor models, Dimentionality reduction and Multi-Deminsional scaling (PCA/MDS) | [Dr. Mark Schmidt](https://www.cs.ubc.ca/~schmidtm/), CPSC340, UBC | 
| [Deep Learning*](https://www.coursera.org/specializations/deep-learning) | Neural networks, Non-linear activation, Hyperparameter optimization, Regularization, Batch-procedures, Convolutional neural networks, Sequence models, Transfer learning | deeplearning.ai |
| [Natural Language Processing*](https://www.coursera.org/specializations/natural-language-processing) | Vector space models, Probabilistic Models, Sequence models, Attention models  | deeplearning.ai |
...
| NLP tasks | Sentiment analysis, Part of Speech tagging, Topic modelling (LDA), Named entity recognition, Text readability, Machine translation | |
| Probablistic modelling | Hidden markov model & Viterbi algorithm, N-grams, Backoff, Perplexity, Word embeddings (Word2Vec, CBOW, Skip-gram, GloVe) | |
